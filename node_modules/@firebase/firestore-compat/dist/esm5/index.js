 ...
 */ function le(e) {
    ...
    // exception is swallowed.
        var r = "FIRESTORE (8.4.1) INTERNAL ASSERTION FAILED: " + e;
    ...
    throw function(e) {
        ...
        if (ce.logLevel <= ae.ERROR) {
            var o = r.map(fe);
            ce.error.apply(ce, t([ "Firestore (8.4.1): " + e ], o));
        }
    }(r), new Error(r);
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var pe = "invalid-argument", he = "failed-precondition", de = "unimplemented", ge = /** @class */ function(t) {
    /** @hideconstructor */
    function r(
    /**
    ...
    r.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var a = i[o];
            if (a.indexOf("//") >= 0) throw new ge(pe, "Invalid segment (" + a + "). Paths must not contain // in them.");
    ...
    r.fromServerFormat = function(e) {
        for (var t = [], n = "", o = 0, i = function() {
            if (0 === n.length) throw new ge(pe, "Invalid field path (" + e + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            t.push(n), n = "";
        }, a = !1; o < e.length; ) {
            var u = e[o];
            if ("\\" === u) {
                if (o + 1 === e.length) throw new ge(pe, "Path has trailing escape character: " + e);
                var s = e[o + 1];
                if ("\\" !== s && "." !== s && "`" !== s) throw new ge(pe, "Path has invalid escape sequence: " + e);
                n += s, o += 2;
            } else "`" === u ? (a = !a, o++) : "." !== u || a ? (n += u, o++) : (i(), o++);
        }
        if (i(), a) throw new ge(pe, "Unterminated ` in path: " + e);
        return new r(t);
    }, r.emptyPath = function() {
        return new r([]);
    }, r;
...
function be(e, t) {
    ...
    if (void 0 !== t.mergeFields && void 0 !== t.merge) throw new ge(pe, "Invalid options passed to function " + e + '(): You cannot specify both "merge" and "mergeFields".');
    return t;
}
...
t) {
    ...
    e = e._delegate), !(e instanceof t)) {
        if (t.name === e.constructor.name) throw new ge(pe, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var r = 
        ...
        throw new ge(pe, "Expected type '" + t.name + "', but it was: " + r);
    }
    return e;
}
...
var Oe = /** @class */ function() {
    ...
    return Object.defineProperty(e.prototype, "_databaseId", {
        ...
        return e && function(e, t, r, n) {
            if (!0 === t && !0 === n) throw new ge(pe, e + " and " + r + " cannot be used together.");
        ...
        get: function() {
            if (!this._appCompat) throw new ge(he, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        ...
        var e = this;
        return h(this._delegate), new Ae(new d(this._delegate, (function(t) {
            return g(e._delegate, t);
        })));
    }, e.prototype.loadBundle = function(e) {
        throw new ge(he, '"loadBundle()" does not exist, have you imported "firebase/firestore/bundle"?');
    }, e.prototype.namedQuery = function(e) {
        throw new ge(he, '"namedQuery()" does not exist, have you imported "firebase/firestore/bundle"?');
    }, e;
}(), Fe = /** @class */ function(t) {
    function r(e) {
...
var Te = /** @class */ function() {
    ...
    return e.forPath = function(t, r, n) {
        if (t.length % 2 != 0) throw new ge(pe, "Invalid document reference. Document references must have an even number of segments, but " + t.canonicalString() + " has " + t.length);
 ...
 */
    ...
    })), e.registerVersion("@firebase/firestore-compat", "0.0.900-exp.894b5da5a");
}
