...
import { ActionCodeInfo, UserCredential, Auth, IdTokenResult, MultiFactorError, MultiFactorResolver, PopupRedirectResolver, Dependencies, AuthCredential, ApplicationVerifier, ConfirmationResult, AuthProvider, MultiFactorUser, NextOrObserver, User, ErrorFn, CompleteFn, Unsubscribe, ActionCodeSettings, Persistence, ProviderId, PhoneAuthCredential } from "@firebase/auth";
declare module "@firebase/auth" {
    ...
    function unlink(user: types.User, providerId: ProviderId): Promise<User>;
